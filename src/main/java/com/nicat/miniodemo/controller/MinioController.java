package com.nicat.miniodemo.controller;

import com.nicat.miniodemo.config.FileTypeUtil;
import com.nicat.miniodemo.service.MinioService;
...
public class MinioController {
    ...
    public Map<String, String> showListObjectNameAndDownloadUrl(@PathVariable String bucketName) {
        ...
        String url = "localhost:8585/minio/download/" + bucketName + "/";
